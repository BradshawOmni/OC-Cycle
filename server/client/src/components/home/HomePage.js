      ...
      <div className="container-fluid">
        <div className="animated fadeIn">
          ...
          <div className="col-sm-6 col-lg-3">
              <div className="card text-black blueBox">
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="card text-black greenBox">
                <div className="card-body pb-0">
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="card text-black pinkBox">
                <div className="card-body pb-0">
                  <div className="btn-group float-right">
                    <button type="button" className="btn btn-transparent dropdown-toggle p-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i className="icon-settings"></i>
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="card text-black orangeBox">
                <div className="card-body pb-0">
                  <div className="btn-group float-right">
                    <button type="button" className="btn btn-transparent dropdown-toggle p-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i className="icon-settings"></i>
